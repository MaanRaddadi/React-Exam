...
function MainPage() {
  ...
  return (
    <>
      ...
      <Header></Header>
      <div className="absolute top-1/2 max-md:static">
        <div className="w-full flex justify-center items-center">
          <input
            className="input input-bordered bg-red mt-10 mb-5 bg-gray-100"
            placeholder="Search Name, Category"
            onChange={handelSearch}
          ></input>
        </div>
        <div className="flex w-full justify-center items-center flex-wrap gap-10  p-2">
          {loading === false &&
